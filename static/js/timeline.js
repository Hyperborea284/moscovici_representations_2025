...
function drawTimeline(data) {
    ...
    addTimeAxis(svg, startDate, endDate, timeScale, svgHeight);

    // Eixo superior semanal
    addWeekAxis(svg, startDate, endDate, timeScale, svgHeight);
}
...
function addTimeAxis(svg, startDate, endDate, timeScale, svgHeight) {
...
function addWeekAxis(svg, startDate, endDate, timeScale, svgHeight) {
    let current = new Date(startDate);
    let weekCount = 1;
